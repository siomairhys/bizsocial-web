  ...
  return (
    <Card className="overflow-hidden border-blue-900/20 bg-gradient-to-br from-[#0f2b74] to-[#081a4f] text-white shadow-xl shadow-blue-950/35">
      <div className="flex items-center justify-between">
        ...
        <span className="rounded-full bg-white/10 px-2 py-1 text-[11px] font-semibold text-blue-100">Ends in 12 days</span>
      </div>
      ...
      <div className="mt-3 grid gap-4 sm:grid-cols-[96px_1fr]">
        ...
        <div>
          ...
          <button
            type="button"
            className="mt-3 rounded-xl border border-white/30 bg-white/10 px-4 py-2 text-sm font-semibold text-white transition hover:bg-white/20"
          >
            View Challenge
          </button>
        </div>
